#!/usr/bin/env bash
# xtmon.sh — Kontinuierliche Ausgabe des Titels des aktiven X11-Fensters
# Events: Fensterfokus-Wechsel + Titeländerungen (Tab-Wechsel im Browser)
# Bei fehlendem aktivem Fenster: Ausgabe "Desktop"
# Abhängigkeit: xprop (xorg-xprop)
# Beenden mit Ctrl-C
